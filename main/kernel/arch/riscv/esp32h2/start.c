 ...
 * Target: ESP32-H2 (RISC-V)
 *
 * File: start.c
 * Description:
 *     Architecture-specific startup routine for the ESP32-H2 platform.
...
static const char *TAG = "arch_esp32h2";
...
{
    ESP_LOGI(TAG, "Magnolia ESP32-H2 booting...");
