 ...
 * Target: ESP32S2 (Xtensa)
 *
 * File: start.c
 * Description:
 *     Architecture-specific startup routine for the ESP32S2 platform.
...
static const char *TAG = "arch_esp32s2";
...
{
    ESP_LOGI(TAG, "Magnolia ESP32-S2 booting...");
