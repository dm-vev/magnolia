...
static const struct m_elfsym g_kernel_libc_syms[] = {
    ...
    { "socket", (void *)m_libc_socket },
    { "connect", (void *)m_libc_connect },
    { "bind", (void *)m_libc_bind },
    { "listen", (void *)m_libc_listen },
    { "accept", (void *)m_libc_accept },
    { "send", (void *)m_libc_send },
    { "recv", (void *)m_libc_recv },
    { "sendto", (void *)m_libc_sendto },
    { "recvfrom", (void *)m_libc_recvfrom },
    { "shutdown", (void *)m_libc_shutdown },
    { "setsockopt", (void *)m_libc_setsockopt },
    { "getsockopt", (void *)m_libc_getsockopt },
    ...
    M_ELFSYM_EXPORT(m_net_list_ifaces),
    M_ELFSYM_EXPORT(m_net_iface_get_info),
    M_ELFSYM_EXPORT(m_net_iface_up),
    M_ELFSYM_EXPORT(m_net_iface_down),
    M_ELFSYM_EXPORT(m_net_iface_set_ipv4),
    M_ELFSYM_EXPORT(m_net_iface_dhcp_start),
    M_ELFSYM_EXPORT(m_net_iface_dhcp_stop),
    M_ELFSYM_EXPORT(m_net_get_stats),
    M_ELFSYM_EXPORT(m_net_get_default_iface),
    M_ELFSYM_EXPORT(m_net_set_default_iface),
    M_ELFSYM_EXPORT(m_net_stats_snapshot_api),
    M_ELFSYM_EXPORT(m_net_socket_summary),
